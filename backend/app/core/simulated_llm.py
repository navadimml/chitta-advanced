    ...
    def _generate_mock_interview_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "video_guidelines": {
                ...
                "why_these_scenarios": "בחרתי את התרחישים האלה על סמך מה שסיפרת לי בראיון. דיברנו על זה שיוני מתקשה בתקשורת ובקשר עין, ועל הקושי שלו ליצור קשר עם ילדים אחרים. דיברנו גם על החוזקות שלו - הזיכרון הטוב והאהבה לפאזלים. התרחישים שבחרתי יעזרו לי לראות את יוני במצבים טבעיים ולהבין טוב יותר איפה הוא צריך תמיכה ואיפה הוא מצליח.",
                "scenarios": [
                    {
                        "title": "משחק חופשי",
                        "description": "צלמו את הילד משחק לבד או עם ילדים אחרים למשך 5-7 דקות",
                        "why_i_chose_this": "דיברנו על זה שיוני אוהב פאזלים ויש לו זיכרון מצוין, אבל מתקשה להתמיד בפעילויות ומתסכל מהר. במשחק חופשי אני אוכל לראות איך הוא בוחר במה לשחק, כמה זמן הוא נשאר עם משהו אחד, ומה קורה כשמשהו לא מצליח. זה יעזור לי להבין איך הוא מתמודד עם רגעים קשים ואיך אפשר לתמוך בו.",
...
חשוב: לא לכוון אותו מה לעשות - תני לו לבחור בעצמו!""",
                        "rationale": "משחק חופשי מגלה איך הילד בוחר פעילויות, כמה זמן הוא מתמיד, ואיך הוא מגיב לתסכול",
                        "detailed_rationale": """במשחק חופשי אני יכולה לראות:

איך הילד חושב ופותר בעיות:
- האם הילד מתכנן את המשחק או פועל באימפולס?
- איך הוא פותר בעיות (למשל, מגדל שקורס)?
- האם יש משחק דמיון והעמדת פנים?

איך הוא מתמודד עם רגשות:
- איך הילד מגיב כשמשהו לא מצליח?
- האם הוא ממשיך לנסות או נותן ויתור מהר?
- כמה זמן הוא יכול להתמקד בפעילות אחת?

איך הגוף שלו עובד:
- איך הוא אוחז בדברים (עפרון, קוביות)?
- תיאום בין מה שהעיניים רואות למה שהידיים עושות
- איך הוא זז במרחב (אם משחק פעיל)

זו הזדמנות לראות את הילד כמו שהוא באמת, בלי שמישהו אומר לו מה לעשות.""",
                        "priority": "essential",
                    ...
                    },
                    {
                        ...
                        "why_i_chose_this": "סיפרת לי שיוני נמנע מקשר עין ומתקשה בתקשורת - מדבר במילים בודדות וקשה לו לבנות משפטים. המטרה שלך היא שישתפר בתקשורת ושיוכל לשחק עם ילדים אחרים. התרחיש הזה יעזור לי לראות איך הוא מתקשר עם אחרים, האם יש קשר עין, איך הוא מבקש דברים, ומה קורה במשחק משותף. זה מאוד חשוב כדי להבין איך לעזור לו.",
...
חשוב: המצב צריך להרגיש טבעי - לא הופעה מול המצלמה""",
                        ...
                        "detailed_rationale": """באינטראקציה חברתית אני בודקת:
