...
class ChittaService:
    ...
    def _get_llm(self):
        """Lazy load LLM provider for conversation (Phase 1 & 2)"""
        if self._llm is None:
            import os
            from app.services.llm.factory import create_llm_provider

            # Use fast model for conversation phases
    ...
    def _get_strong_llm(self):
        """Get strong LLM for heavy tasks (pattern recognition, artifact creation)"""
        import os
        from app.services.llm.factory import create_llm_provider
