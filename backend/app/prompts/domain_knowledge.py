...
יש לך עוד שאלות על זה?"""
    ...
    "sharing_with_professionals": {
        ...
        "answer_hebrew": """שאלה מצוינת! כן, בהחלט אפשר לשתף מידע עם אנשי מקצוע.

**איך זה עובד?**

**הכל דיגיטלי** - אין טפסים, חתימות, או ניירת! 💙

1. **בחירה**: אתה בוחר באפליקציה עם איזה איש מקצוע אתה רוצה לשתף
   • מטפל, רופא, מורה, יועץ בית ספר, וכו'

2. **הרשאה דיגיטלית**: אתה מאשר דיגיטלית בלחיצה
   • בוחר מה לשתף (דוח, סרטונים, יומן, הכל)
   • קובע לכמה זמן (זמני או קבוע)

3. **שליטה מלאה**: אתה יכול לשנות או לבטל בכל רגע
   • לראות מי רואה מה
   • לבטל גישה בלחיצה
   • לשנות הרשאות בכל זמן
...
**הכל מנוהל דיגיטלית דרך האפליקציה בשקיפות מלאה ובשליטתך המלאה.** 💙

**השליטה שלך:**
• אתה בוחר עם מי לשתף
• אתה בוחר מה לשתף
• אתה יכול לבטל בכל רגע

זה בדיוק אחד מהכלים החשובים של צ'יטה - לאפשר לך לנהל בקלות את כל המעגל הטיפולי סביב {child_name}.
